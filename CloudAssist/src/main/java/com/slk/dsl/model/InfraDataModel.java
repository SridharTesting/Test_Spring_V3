...
@Entity
@Table(name="ca_infra_data")
public class InfraDataModel {

	@Id @GeneratedValue(strategy=GenerationType.IDENTITY)
	@Column(name="Infra_Id",nullable = false, unique = true)
	private int infraId;
	...
	public InfraDataModel(int infraId, int orgId, String hostName, String ipAddress, String hypervisor, String osType,
	...
	public InfraDataModel() {
		// TODO Auto-generated constructor stub
	}
	
	public InfraDataModel(MultipartFile file) {
		// TODO Auto-generated constructor stub
	}
